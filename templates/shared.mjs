...
#term-tip { position:fixed; z-index:999; background:#24292f; color:#fff; padding:5px 12px; border-radius:8px;
  font-size:12.5px; white-space:nowrap; box-shadow:0 4px 14px rgba(0,0,0,.3);
  pointer-events:none; display:none; }
#term-tip { font-weight:600; letter-spacing:.02em; }
